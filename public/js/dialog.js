...
window.addEventListener('show-delete-confirmation-sector', function (event) {
...
window.addEventListener('show-delete-confirmation-option', function (event) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    title: 'Are-you sure ',
...
window.addEventListener('show-delete-confirmation-teacher', function (event) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    title: 'Are-you sure ',
