  ...
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="addClassePrimaryModal" tabindex="-1" role="dialog" aria-labelledby="addClassePrimaryModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addClassePrimaryModalLabel">ADD NEW CLASS PRIMARY</h5>
