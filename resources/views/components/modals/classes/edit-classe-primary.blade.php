  ...
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="editClassePrimaryModal" tabindex="-1" role="dialog" aria-labelledby="editClassePrimaryModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editClassePrimaryModalLabel">EDIT NEW CLASS PRIMARY</h5>
