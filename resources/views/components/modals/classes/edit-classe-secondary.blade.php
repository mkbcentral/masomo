  ...
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="editClasseSecondaryModal" tabindex="-1" role="dialog" aria-labelledby="editClasseSecondaryModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editClasseSecondaryModalLabel">EDIT NEW CLASS SECONDARY</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="button"  wire:click.prevent='updateClasse' class="btn btn-primary">Save changes</button>
        </div>
      </div>
    </div>
  </div>
