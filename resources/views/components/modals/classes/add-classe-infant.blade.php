  ...
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="addClasseInfantModal" tabindex="-1" role="dialog" aria-labelledby="addClasseInfantModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addClasseInfantModalLabel">ADD NEW CLASS INFANT</h5>
