  ...
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="editClasseInfantModal" tabindex="-1" role="dialog" aria-labelledby="editClasseInfantModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editClasseInfantModalLabel">EDIT  CLASS INFANT</h5>
