<div>
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#addClasseInfantModal">
                    ...
                    @foreach ($classes as $classe)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" type="button" data-toggle="modal" data-target="#editClasseInfantModal" wire:click='edit({{$classe}})'><i class="fas fa-edit    "></i></a>
    ...
    @include('components.modals.classes.add-classe-infant')
    @include('components.modals.classes.edit-classe-infant')
</div>
